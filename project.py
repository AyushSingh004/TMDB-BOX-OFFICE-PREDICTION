...
# 
# 
# dtr.predict([[120000,5]])
# 
# 
# 
# 
# dataset1.loc[dataset1.genres.isnull(), 'genres'] = "{}"
# dataset1['genres'] = dataset1.genres.apply(lambda x: sorted([d['name'] for d in eval(x)])).apply(lambda x: ','.join(map(str, x)))
# genres = dataset1.genres.str.get_dummies(sep=',')
# 
# 
...
# 
# 
# dataset1.iloc[1]['genres']
# type(dataset1.iloc[1]['genres'][0])
# dataset1[['genres']].dtypes
# dataset1.head().iloc[1]['genres']
# 
# 
# 
# dataset1=dataset1.drop(['belongs_to_collection'],axis=1)
# dataset1=dataset1.drop(['homepage'],axis=1)
# dataset1=dataset1.drop(['imdb_id'],axis=1)
# dataset1=dataset1.drop(['original_language'],axis=1)
# dataset1=dataset1.drop(['overview'],axis=1)
# dataset1=dataset1.drop(['poster_path'],axis=1)
# dataset1=dataset1.drop(['production_companies'],axis=1)
# dataset1=dataset1.drop(['production_countries'],axis=1)
# dataset1=dataset1.drop(['release_date'],axis=1)
# dataset1=dataset1.drop(['spoken_languages'],axis=1)
# dataset1=dataset1.drop(['status'],axis=1)
# dataset1=dataset1.drop(['tagline'],axis=1)
# dataset1=dataset1.drop(['title'],axis=1)
# dataset1=dataset1.drop(['Keywords'],axis=1)
# dataset1=dataset1.drop(['cast'],axis=1)
# dataset1=dataset1.drop(['crew'],axis=1)
# dataset1=dataset1.drop(['original_title'],axis=1)
# 
# 
# X=dataset1.iloc[:,:-1].values
# y=dataset1.iloc[:,-1].values
# 
# dataset1['genres'].fillna('No Genres',inplace=True)
# 
# 
